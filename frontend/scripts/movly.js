...
const dictionaries = {
  ...
  it: {
    ...
    loadError: "Non riesco a caricare il film di oggi. Riprova più tardi.",
    poolLabel: "Pool film",
    ...
    duplicate: "Hai già provato {movie}",
    loadingMessage: "Movly sta ancora caricando",
    sameSaga: "Stessa saga, ma non è questo.",
    sameSagaPill: "Stessa saga",
    yearOlder: "Il film corretto è più vecchio.",
    yearNewer: "Il film corretto è più recente.",
    yearSame: "Il film corretto è dello stesso anno.",
